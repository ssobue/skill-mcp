...
- Discover Skills by scanning `skill.yaml` manifests.
...
The catalog is rebuilt from Git/worktree scans after restart. This is acceptable for v1 because Git remains the source of truth.
